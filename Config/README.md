...
## 查询所有或一个pack
```
packname=$(aws configservice delete-conformance-pack --conformance-pack-name=$packname --region=$region --query 'ConformancePackDetails.ConformancePackName[*]' --output text )
```
## 查看所有region的所有一致性包
```
